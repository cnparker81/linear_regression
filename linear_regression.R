...
setwd("C:/Users/cparker/Downloads/linear_regression")

##   You might also start by listing the files in your working directory

getwd("C:\Users\cparker\Downloads\linear_regression") # where am I?
...
summary(energy4)
anova(energy4)
## There are diiferences in the region, but they do notappear to significantly affect the model?